    ...
    if ~isfield(g.eventedit, 'SelEventStruct');
        ...
        results=inputgui( ...
            ...
            {'Style', 'pushbutton', 'string', '...', 'tag', 'ChanLabelButton',... 
                  'callback', ['g=get(findobj(''tag'', ''EEGPLOT''),''UserData''); [ChanLabelIndex,ChanLabelStr,ChanLabelCell]=pop_chansel({g.eloc_file.labels});' ...
            ...
            'pophelp(''pop_fig_EditEvent'');', 'event edit -- pop_fig_EditEvent()', [], 'normal'); 
        %close;
