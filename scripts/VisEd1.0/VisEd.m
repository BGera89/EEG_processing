...
try g.spacing; catch, g.spacing = 50; end; 
...
switch DataType
    ...
    case 2
        ...
        if option_computeica
            ...
            data = (EEG.icaweights*EEG.icasphere)*reshape(EEG.data(EEG.icachansind,:,:), length(EEG.icachansind), EEG.trials*EEG.pnts);
...
%SRIVAS - need to set icacomp to 1 for VisEd to pick up trials marked as
%bad by markartifacts
icacomp=1;
nbpnts=EEG.pnts;
